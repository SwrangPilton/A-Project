    ...
    return (
        <div className='absolute top-0 z-50 bg-white padding signin w-screen h-screen'>
            <nav className='grid grid-cols-2 mb-6'>
                ...
                <VscChromeClose className='ml-auto text-4xl text-white ' />
            </nav>

            <div className="box text-white text-2xl w-1/4 bg-gray-800/80 px-10 py-12 rounded-lg mx-auto">
                <form>
                    <div className="relative z-0 w-full mb-6 group">
                        <input type="email" name="floating_email" className="rounded-xl px-3 block py-2.5  w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
