        ...
        <div className='wall'>
            <div className="grid grid-cols-1 lg:grid-cols-6 relative">
                {data && (
                    <React.Fragment>
                        <div className='col-span-4 order-1 lg:order-2 '>
                            <iframe title='Wall' className='w-full h-full ' src={data.video} frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen>
                            </iframe>
                ...
                flex flex-wrap flex-col justify-center order-2 lg:order-1 md:p-[30px] lg:p-[0 100px]">
                            ...
                            <div className='space-x-2 lg:space-x-4 my-5 '>
                                <button className='pl-5 lg:pl-7 border-2 border-transparent bg-red-600 hover:bg-red-500 cursor-pointer'>
